          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
            ...
            <div className="glass-card rounded-[2.5rem] p-10 border-white/10 relative overflow-hidden group">
              ...
              <div className="grid md:grid-cols-1 gap-8">
                {[
                  { 
                    title: "Performance Max & AI", 
                    desc: "Engenharia de prompts e sinais para o algoritmo de IA do Google.",
                    icon: <Zap size={20} />
                  },
                  { 
                    title: "Rede de Pesquisa Avançada", 
                    desc: "Captura cirúrgica de demanda com foco em intenção de compra.",
                    icon: <Search size={20} />
                  },
                  { 
                    title: "Display & Youtube Strategy", 
                    desc: "Criação de demanda e branding para públicos de alto padrão.",
                    icon: <Layout size={20} />
                  }
                ].map((item, i) => (
