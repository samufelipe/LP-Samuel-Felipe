...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setIsSubmitted(true);
    // Reset after some time if needed, or just keep it
  };
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="relative group">
                      <input 
                        ...
                        className="w-full bg-white/[0.03] border border-white/5 rounded-xl md:rounded-2xl p-4 md:p-5 text-sm md:text-base focus:outline-none focus:border-yellow-500/50 focus:bg-white/[0.05] transition-all text-white placeholder:text-gray-600"
                      />
